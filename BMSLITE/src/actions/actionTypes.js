...
export const GET_CONFIGURATION_OVWERVIEW_SUCCESS  = 'GET_CONFIGURATION_OVWERVIEW_SUCCESS';
export const GET_CONFIGURATION_OVWERVIEW_FAIL  = 'GET_CONFIGURATION_OVWERVIEW_FAIL';
